...
## Contact
- Email: lojainfallatah3@gmail.com
- LinkedIn: [linkedin.com/in/lojain-fallatah](https://www.linkedin.com/in/lojain-fallatah/)

---

## About Me
I am an AI specialist with experience in deep learning, natural language processing, and cybersecurity. Passionate about developing innovative projects that solve real-world problems.

---

## Projects

### 1. Waste Detection System
- Built a real-time waste detection system using YOLOv8 for object detection.
- Integrated OpenAI Vision-Language Model (VLM) to validate predictions and distinguish complex waste categories.
- Runs VLM tasks in background processing threads to keep system fast and optimized.
...
- **Repository:** [Abandoned Object Detector](https://github.com/lojainfallatah23/cv-abandoned-object-detector/tree/main)
